...
var startStateHandlers = Alexa.CreateStateHandler(GAME_STATES.START, {
    "StartGame": function (newGame) {
        ...
        var firstCount = accounts[0][socialNetwork].Count;
        var secondCount = accounts[1][socialNetwork].Count;
        var correctAnswerText = parseInt(firstCount) > parseInt(secondCount) ? accounts[0].name : accounts[1].name;
...
function handleUserGuess(userGaveUp) {
    ...
    if (this.event.request.intent.slots.Answer.value.toLowerCase() == this.attributes["correctAnswerText"].toLowerCase()) {
        currentScore++;
